...
```{r Fig_2_Map_Richness_Mid_Domain_vs_Neutral,fig.width=12,fig.height=18,echo=FALSE,message=FALSE,results='hide',warning=FALSE}
...
```{r Fig_3_Map_Composition_Mid_Domain_vs_Neutral,fig.width=12,fig.height=18,echo=FALSE,message=FALSE,results='hide',warning=FALSE}
