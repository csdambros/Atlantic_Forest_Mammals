...
```{r Fig S3. Map Composition Mid Domain vs Neutral,fig.width=18,fig.height=6,echo=FALSE,message=FALSE,results='hide'}
...
```{r comparisons of the models - richness, echo=FALSE}
