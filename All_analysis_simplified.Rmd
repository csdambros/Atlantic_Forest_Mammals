...
print(xtable(data.frame(modeln=strsplit("MR1.1,MR1.2,MR1.3,MR1.4,MR1.5,MR1.6,MR1.7,MR1.8,MR1.9,MR1.10,MR1.11,MR1.12,MR1.13,MR1.16,MR1.17,MR1.18,MR1.19,MR1.20",",")[[1]],Model=c("rawClim","rawClim+Neu","rawClim+Mid","Neutral","Mid domain","ResN~rawClim","ResN~rawClim","Cimatic","Climatic+Neu","Climatic+Mid","rawHab","rawHab+Neu","rawHab+Mid","ResN~rawHab","ResN~rawHab","Habitat","Habitat+Neu","Habitat+Mid"),logLik=logLik,npar=npar,AIC=-2*logLik+2*npar,rsquares=rsquares,BIASsq=BIASsq,VAR=VAR,MSE=BIASsq+VAR)[c(8,16,5,4),-1]),type=table.type,html.table.attributes="border=1, bgcolor=#989898",comment=FALSE)
